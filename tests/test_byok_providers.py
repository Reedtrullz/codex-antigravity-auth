...
class TestBYOKProviders(unittest.TestCase):
    ...
    def test_models_endpoint_includes_documented_builtin_aliases(self):
        ...
        self.assertEqual(by_id["claude-opus-4-6-thinking"]["display_name"], "Claude Opus 4.6 (Google)")
        self.assertEqual(by_id["claude-opus-4-6-thinking"]["default_reasoning_level"], "xhigh")
        self.assertEqual(by_id["gemini-3.5-flash-high"]["owned_by"], "google-antigravity")
